...
print('ss= %.4f '% ss(x_std, model.labels_, metric='euclidean'))
...
print('PCA+KMeans Silhouette= %.4f  '% ss(reduct, kmeans.labels_)     )
print('Accuracy= %.4f   ' % accuracy_score(pred2, y_digits)                 )
